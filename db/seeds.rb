...
instruction_list = [
  ...
  [2, "Tops", "Square the House", "In waltz hold, slide slide (slide together, slide together) the couple on the right, poviot slide together 123 to oposite, House half-way, repeat all back to home.", 8, 11],
  ...
  [8, "Tops", "Slide and Change", "In waltz hold slide in (1, 2, 123) and back, House half-way, repeat all back to home.", 16, 11],
  # Ballyvourney figure Two
  [1, "Tops", "House", "in waltz hold, dance 2 seting step and house around", 8, 12],
  [2, "Tops", "Square the House", "In waltz hold, slide the couple on the right (slide together, slide together), poviot (slide together 123) to oposite, House half-way, repeat all back to home.", 8, 12],
  [2, "Top Gents", "Swing Oposite", "gents cross the set and swing the oposite lady.", 8, 12],
  ...
  [7, "Sides", "Swing", "in waltz hold swing your partner", 8, 12],
  [8, "Sides", "Slide and Change", "In waltz hold slide in (1, 2, 123) and back, House half-way, repeat all back to home.", 16, 12],
  # Ballyvourney figure Three
  [1, "Tops", "House", "in waltz hold, dance 2 seting step and house around", 8, 13],
  [2, "Tops", "Square the House", "In waltz hold, slide the couple on the right (slide together, slide together), poviot (slide together 123) to oposite, House half-way, repeat all back to home.", 8, 13],
  [3, "Tops", "Christmas", "both couples join hands behind each other’s backs and swing clockwise, falling back to place on the last 2 bars.", 16, 13],
  ...
  [7, "Sides", "Christmas", "both couples join hands behind each other’s backs and swing clockwise, falling back to place on the last 2 bars.", 16, 13],
  ...
  [2, "Tops", "Square the House", "In waltz hold, slide the couple on the right (slide together, slide together), poviot (slide together 123) to oposite, House half-way, repeat all back to home.", 8, 14],
  [3, "Top Gents", "Swing all the ladies", "swing the lady on the left, move on to the next until home", 32, 14],
  ...
  [7, "Side Gents", "Swing all the ladies", "swing the lady on the left, move on to the next until home", 32, 14],
  ...
  [2, "Tops", "Square the House", "In waltz hold, slide the couple on the right (slide together, slide together), poviot (slide together 123) to oposite, House half-way, repeat all back to home.", 8, 15],
  [3, "All", "Reverse Chain", "face partners and, taking right hand in right, trade palces, face eachother and chain in that direction.", 32, 15],
  [4, "All", "Swing", "in waltz hold swing your partner", 8, 15],
  [5, "All", "Slide and Change", "In waltz hold slide in (1, 2, 123) and back, House half-way, repeat to oposite position.", 16, 15],
  [6, "Sides", "House", "in waltz hold, dance 2 seting step and house around", 8, 15],
  [7, "Sides", "Square the House", "In waltz hold, slide slide the couple on the right, poviot slide, 123 to oposite, House half-way, repeat all back to home.", 8, 15],
  [8, "All", "Reverse Chain", "face partners and, taking right hand in right, trade palces, face eachother and chain in that direction.", 32, 15],
  [9, "All", "Swing", "in waltz hold swing your partner", 8, 15],
  [10, "All", "Slide and Change", "In waltz hold slide in (1, 2, 123) and back, House half-way, repeat to oposite position.", 16, 15],
  [11, "All", "House", "in waltz hold house around to finish", 8, 15],
]
